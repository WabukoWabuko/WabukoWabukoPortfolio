import { useContext } from 'react';
   ...
   function Footer() {
     ...
     const handleEmailClick = () => {
       window.open('mailto:wabuko@example.com', '_self');
     };
     ...
     const handleTwitterClick = () => {
       window.open('https://twitter.com/WabukoWabuko', '_blank');
     };

     const handleInstagramClick = () => {
       window.open('https://instagram.com/wabuko.wabuko', '_blank');
     };

     const handleWhatsAppClick = () => {
       window.open('https://wa.me/+254123456789', '_self');
     };
